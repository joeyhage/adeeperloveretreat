...
export default class Testimonials extends React.Component {
	...
	render() {
        ...
        <h1 className='title has-text-centered is-size-1-desktop is-size-3-touch'>Testimonials</h1>
              ...
              <div className='tile'>
                <div className='tile is-parent is-vertical is-6'>
                  <article className='tile is-child notification' style={{backgroundColor:'hsl(221, 15%, 41%)'}}>
                    ...
                    It made it very manageable, but yet a great <span style={{whiteSpace:'nowrap'}}>experience.&nbsp;
                      <FontAwesomeIcon icon={faQuoteRight} alt='Quote Right' /></span></p>
                    <p className='subtitle is-italic is-uppercase'style={{color:'#FFF'}}> -Breanne and Sam K.</p>
                  </article>
                  <article className='tile is-child notification'style={{backgroundColor:'hsl(221, 15%, 46%)'}}>
                    <p className='subtitle' style={{color:'#FFF'}}><FontAwesomeIcon icon={faQuoteLeft} alt='Quote Left' />&nbsp;We enjoyed taking some time for to focus on just us and not the needs
                      ...
                      What a relaxing day to <span style={{whiteSpace:'nowrap'}}>reconnect!&nbsp;<FontAwesomeIcon icon={faQuoteRight} alt='Quote Right' /></span></p>
                      <p className='subtitle is-italic is-uppercase'style={{color:'#FFF'}}> -Kayla and Kyle </p>
                  </article>
                  <article className='tile is-child notification'style={{backgroundColor:'hsl(221, 15%, 51%)'}}>
                    <p className='subtitle'style={{color:'#FFF'}}><FontAwesomeIcon icon={faQuoteLeft} alt='Quote Left' />&nbsp;My husband and I felt spoiled by a whole day to nourish our relationship! 
                      ...
                      in the daily grind, I've been motivated to love better by looking back at moments that struck me from 
                      the <span style={{whiteSpace:'nowrap'}}>retreat.&nbsp;<FontAwesomeIcon icon={faQuoteRight} alt='Quote Right' /></span></p>
                    <p className='subtitle is-italic is-uppercase'style={{color:'#FFF'}}> -Tessa and Roberto</p>
                  </article>
                </div>
