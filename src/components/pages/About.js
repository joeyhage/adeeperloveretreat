              ...
              <div className='tile'>
                <div className='tile is-parent is-vertical is-8'>
                  ...
                  <article className='tile is-child notification' style={{backgroundColor:'hsl(324,7%,46%)'}}>
                    ...
                    <p className='subtitle'>This year our third annual marriage retreat will be held at our farm, Weber Farm. 
                      Why you ask? Well after having the retreat last August in Ames at St. Thomas, I realized it didn’t give 
                      the retreat feeling I was wanting. I wanted couples to come and feel calm, energized, and not worry about 
                      children or the fast paced world! I wanted couples to come see the sunset, walk on the gravel roads, or 
                      play games without children interrupting them. I wanted to have them enjoy meals with their spouse and 
                      other like-minded adults! I wanted a retreat to focus on marriage and the gifts within the beauty God 
                      has given us all. Due to the new venue and wanting to maintain the peacefulness of the farm, we will 
                      not have babysitting provided this year. However, if you need assistance in finding a reliable sitter 
