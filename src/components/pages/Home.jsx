          ...
          <section className='section'>
            <div className='container' style={{backgroundColor:'#6D7993', padding:'1em', borderRadius:'10px'}}>
              <div style={{padding:'.8em'}}>
                ...
                <img src='https://cdn.glitch.com/b8ab5d72-f094-4be6-b779-eb4ed16e6d67%2FSaveTheDate_Aug17_2019.png?1550114730928' 
                     alt='Save the Date - August 17th, 2019' style={{maxHeight:'30em', display:'block',margin:'auto'}}/>
              </div>
            </div>
          </section>
